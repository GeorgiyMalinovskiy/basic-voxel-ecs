...
/**
 * Cubic voxel mesh generator (Minecraft-style blocks with face culling)
 * Generates blocky meshes from voxel data
 */
export class CubicVoxelMesher {
